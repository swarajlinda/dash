        ...
        >
          ...
          <div className="tabs-container  mx-10">
            <div className="tabs  ">
              <div
                className={`tab ${
                  (activeTab === 0 ? "active" : "w-10", "h-9 bg-blue-900 text-white  font-bold")
                } `}
              ...
              <div
                className={`tab ${activeTab === 1 ? "active" : " bg-blue-900 text-white  font-bold"}`}
                onClick={() => handleTabClick(1)}
               
              >
                <p className="  flex  mx-2 ">
                  {" "}
                  <FaFirstdraft className=" mx-2 my-1 " /> Money Receipt
                </p>
              </div>
            </div>
          </div>
          ...
          {activeTab === 0 && (
            <div className=" h-screen w-4/5">
              ...
              <button
                ...
                class="block text-white bg-blue-900 mx-12 my-2 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                type="button"
               >
                Billing Element
              </button>
